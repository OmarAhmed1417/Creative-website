...
two2.onclick=function(){
    ...
    one.style.transform="translateX(-101%)"
    two.style.transform="translateX(-101%)"
    three.style.transform="translateX(-101%)"
    four.style.transform="translateX(0%)"
    one.style.transition=2+'s';
    two.style.transition=2+'s';
    three.style.transition=2+'s';
...
three3.onclick=function(){
    ...
    three.style.transform="translateX(-201%)"
    one.style.transform="translateX(-201%)"
    two.style.transform="translateX(-201%)"
    four.style.transform="translateX(-201%)"
    one.style.transition=2+'s';
    two.style.transition=2+'s';
    three.style.transition=2+'s';
    four.style.transition=2+'s';
...
four4.onclick=function(){
    three.style.transform="translateX(-301%)"
    one.style.transform="translateX(-301%)"
    two.style.transform="translateX(-301%)"
    four.style.transform="translateX(-301%)"
    one.style.transition=2+'s';
    two.style.transition=2+'s';
    three.style.transition=2+'s';
    four.style.transition=2+'s';
...
bar.onclick=function(){
  ...
  value.onclick=function(){
    window.open('/Arapic/project5/shop.html')
  }